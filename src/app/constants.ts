...
export const CONTACTS = {
  ...
  // Часы работы
  workHours: '10:00 — 18:00 пн-пт, суббота по предварительному звонку или заявке',
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  { q: "Можно ли взять велосипед на 1–2 дня?", a: "Да, у нас есть посуточная аренда. Минимальный срок — 1 сутки, стоимость от 1000 руб." },
  { q: "Нужен ли залог?", a: "Нет, залог не требуется." },
  { q: "Как быстро забрать велосипед после заявки?", a: "Обычно оформление занимает 5–10 минут, если есть свободный байк." },
  { q: "Что делать, если аккумулятор сел во время смены?", a: "Можем обменять на заряженный по предварительной договоренности. Стоимость 300 руб." },
  { q: "Можно ли работать с двумя аккумуляторами?", a: "Да, тарифы «Заработок» и «Партнёр» предусматривают аренду в том числе и с 2 АКБ." },
  { q: "Как продлить аренду?", a: "Через MAX, Telegram-бота или по телефону до окончания текущего срока." },
  { q: "Есть ли доставка велосипеда?", a: "Самовывоз из пункта выдачи. По Оренбургу доставка возможна по предварительной договорённости." },
  { q: "Что будет, если велосипед украдут?", a: "При оформлении подписывается договор с прописанной ответственностью. Рекомендуем использовать замок и сигнализацию." }
];
