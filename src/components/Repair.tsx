...
const repairServices = [
  {
    ...
    description: 'Диагностика, ремонт электроники, замена аккумуляторов, ТО'
  },
  {
    icon: '🛴',
    title: 'Электросамокаты',
    description: 'Ремонт двигателей, контроллеров, тормозных систем, ТО'
  },
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-black text-slate-100 mb-4">
            Ремонт электросамокатов и электровелосипедов в Оренбурге
          </h2>
          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">
            Чиним электровелосипеды, самокаты и другой электротранспорт. Быстро, профессионально, по делу.
          </p>
        </div>
