...
const tariffs = [
  {
    name: 'Базовый',
    subtitle: 'АКБ 45 Ah · стандартные смены',
    price: '3 200',
    period: 'в неделю',
    icon: '🚲',
    image: '/images/tariff-basic.webp',
    features: [
      'аккумулятор емкостью 45 Ah',
  ...
  {
    name: 'Заработок',
    subtitle: '2 АКБ: 45 Ah + 45 Ah · увеличенный пробег',
    price: '3 900',
    period: 'в неделю',
    icon: '🚀',
    ...
    features: [
      ...
      'Корзина, замок, держатель для телефона, защитный тент',
  ...
  },
  {
    ...
    features: [
      ...
      'Не беспокоиться об обслуживании и запасных частях',
      'минималльная стоимость 12 500 при месячной аренде с 1 АКБ'
    ],
    popular: false
  }
];
