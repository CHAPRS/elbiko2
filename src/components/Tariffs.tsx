...
const tariffs = [
  {
    name: 'Базовый',
    subtitle: 'АКБ 30 Ah · стандартные смены',
    price: '3 200',
    period: 'в неделю',
    icon: '🚲',
    image: '/images/tariff-basic.webp',
    features: [
      'аккумулятор емкостью 30 Ah',
      'Корзина, держатель для телефона и замок в комплекте',
  ...
  {
    name: 'Заработок',
    subtitle: '1 или 2 АКБ: 45 Ah + 45 Ah · увеличенный пробег',
    price: '3 500',
    period: 'в неделю',
    icon: '🚀',
    image: '/images/tariff-earning.webp',
    features: [
      '1 аккумулятора увеличенной емкости',
      '2 АКБ: 45 Ah + 45 Ah за 4 300 руб. в неделю',
      'Корзина, замок, держатель для телефона',
      'Техосмотр перед выдачей и бесплатное ТО каждые 14 дней',
      'Подходит для полных рабочих дней',
      'Возможность полной зарядки 1 АКК в офисе за 300 руб.'
    ],
    popular: true
  },
  {
    name: 'Партнер',
    subtitle: '1 или 2 АКБ × 45 (30) Ah · для длинных смен',
    price: '* от 12 000',
    period: 'в месяц',
    icon: '⭐',
    ...
    features: [
      ...
      '1 или 2 аккумулятора максимальной емкости',
      'подменный, новый аналогичный электровелосипед на время ТО',
      'до 3 дней в месяц бесплатно',
      '2 бесплатных ТО в течении месяца',
      'Не беспокоиться об обслуживании и запасных частях',
      '*минималльная стоимость 12 000 при месячной аренде с 1 АКБ 30 Ah',
      '**стоимость аренды с несколькими АКБ зависит от количества и емкости батарей, уточняйте у менеджера',
    ],
    popular: false
  }
];
